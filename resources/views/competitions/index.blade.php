    ...
    <div class="competitionsHolder">
        ...
        <div class="competitiveHolder">
            ...
            <a href="/competitions/{{ $type->url }}" class="competitiveBlock">
                <h2>{{ $type->title }}</h2>
                <p class="competitiveYears"><span class="yellow">{{ $type->years }}</span><br />{{ $type->competitions()->count() }} Competitions</p>
