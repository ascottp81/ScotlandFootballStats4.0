...
@section('content')
    ...
    <div class="honourImage">
        @if (config('app.livemedia'))
            ...
            <!-- Carling Nations Cup -->
            <div class="getty embed image" style="background-color:#fff;display:inline-block;font-family:Roboto,sans-serif;color:#a7a7a7;font-size:11px;width:203px;max-width:397px;height:304px;"><div style="padding:0;margin:0;text-align:left;"><a href="http://www.gettyimages.co.uk/detail/114926791" target="_blank" style="color:#a7a7a7;text-decoration:none;font-weight:normal !important;border:none;display:inline-block;">Embed from Getty Images</a></div><div style="overflow:hidden;position:relative;height:0;padding:149.62216% 0 0 0;width:100%;"><iframe src="//embed.gettyimages.com/embed/114926791?et=YVdaCKD3RGpGAcRsNOcG4A&tld=co.uk&sig=wQOeU16UD1aBMEloz075DDD8JV0Pb99KxLJHyWwfCdA=&caption=true&ver=1" scrolling="no" frameborder="0" width="397" height="594" style="display:inline-block;position:absolute;top:0;left:0;width:100%;height:100%;margin:0;"></iframe></div></div>
        @else
            <!-- FIFA World Cup -->
            ...
            <!-- Carling Nations Cup -->
            <div class="getty localGetty"><img src="/storage/getty/114926791.jpg" style="height:304px;" /></div>
